...
def if_nnapi(supported, not_supported = [], supported_android = None):
    ...
    return select({
        clean_dep("@org_tensorflow//tensorflow:emscripten"): not_supported,
        clean_dep("@org_tensorflow//tensorflow:ios"): not_supported,
        clean_dep("@org_tensorflow//tensorflow:macos"): not_supported,
        clean_dep("@org_tensorflow//tensorflow:windows"): not_supported,
        clean_dep("@org_tensorflow//tensorflow:android"): supported_android,
...
def tflite_hexagon_nn_skel_libraries():
    ...
    return ["@org_tensorflow//third_party/hexagon_nn_skel:libhexagon_nn_skel"]
    """
    return []
...
def flex_portable_tensorflow_hdrs():
    ...
    return [
        "@org_tensorflow//tensorflow/core/lib/gif:hdrs",
        "@org_tensorflow//tensorflow/core/lib/jpeg:hdrs",
        "@org_tensorflow//tensorflow/core/lib/jxl:hdrs",
        "@org_tensorflow//tensorflow/core/lib/png:hdrs",
        "@org_tensorflow//tensorflow/core/lib/webp:hdrs",
    ]
