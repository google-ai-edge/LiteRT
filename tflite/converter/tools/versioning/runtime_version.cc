  ...
  static const std::map<std::pair<BuiltinOperator, int>, std::string>*
      op_version_map =
          new std::map<std::pair<BuiltinOperator, int>, std::string>({
              ...
              {{BuiltinOperator_BROADCAST_TO, 4}, "2.23.0"},
              ...
              {{BuiltinOperator_CONCATENATION, 7}, "2.23.0"},
              ...
              {{BuiltinOperator_GATHER, 8}, "2.23.0"},
              ...
              {{BuiltinOperator_GATHER_ND, 6}, "2.23.0"},
              ...
              {{BuiltinOperator_PADV2, 6}, "2.23.0"},
              ...
              {{BuiltinOperator_UNPACK, 6}, "2.23.0"},
              ...
              {{BuiltinOperator_DEQUANTIZE, 9}, "2.23.0"},
