...
# LINT.ThenChange(//depot/google3/third_party/tensorflow/lite/build_def.bzl:tflite_copts)
...
# LINT.ThenChange(//depot/google3/third_party/tensorflow/lite/build_def.bzl:tflite_copts_warnings)
