...
load("//tflite/converter:special_rules.bzl", "flex_portable_tensorflow_deps")
...
# LINT.ThenChange(//depot/google3/third_party/tensorflow/lite/delegates/flex/build_def.bzl)
