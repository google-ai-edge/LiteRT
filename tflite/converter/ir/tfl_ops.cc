...
#include "tflite/converter/utils/attribute_utils.h"
...
#include "tflite/converter/ir/tfl_canonicalize.inc"
...
void TFLDialect::initialize() {
  addOperations<
#define GET_OP_LIST
#include "tflite/converter/ir/tfl_ops.cc.inc"
      >();
  addAttributes<
#define GET_ATTRDEF_LIST
#include "tflite/converter/ir/tfl_ops_attrdefs.cc.inc"
      >();
...
int GetLengthOfRange(FloatOrInt start, FloatOrInt limit, FloatOrInt delta) {
  ...
  return std::is_integral_v<FloatOrInt>
...
#include "tflite/converter/ir/tfl_ops_interface.cc.inc"
...
#include "tflite/converter/runtime_verifiers.inc"
