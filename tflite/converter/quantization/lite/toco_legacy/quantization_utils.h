...
// LINT.ThenChange(//depot/google3/third_party/tensorflow/lite/tools/optimize/quantization_utils.h:num_elements)
...
// LINT.ThenChange(//depot/google3/third_party/tensorflow/lite/tools/optimize/quantization_utils.h:fill_per_channel_min_max)
...
// LINT.ThenChange(//depot/google3/third_party/tensorflow/lite/tools/optimize/quantization_utils.h:symmetric_per_channel_quantization)
...
void SymmetricPerChannelQuantizeValues(const float* input,
                                       ...
                                       int32_t channel_dim_index,
                                       std::vector<int8_t>* output_value);
// LINT.ThenChange(//depot/google3/third_party/tensorflow/lite/tools/optimize/quantization_utils.h:symmetric_per_channel_quantize_values)
...
// LINT.ThenChange(//depot/google3/third_party/tensorflow/lite/tools/optimize/quantization_utils.h:symmetric_quantize_tensor)
...
absl::Status SymmetricQuantizeTensorPerChannel(ModelT* model, TensorT* tensor,
                                               int32_t channel_dim_index);
// LINT.ThenChange(//depot/google3/third_party/tensorflow/lite/tools/optimize/quantization_utils.h:symmetric_quantize_tensor_per_channel)
...
// LINT.ThenChange(//depot/google3/third_party/tensorflow/lite/tools/optimize/quantization_utils.h:quantize_tensor_float16)
...
// LINT.ThenChange(//depot/google3/third_party/tensorflow/lite/tools/optimize/quantization_utils.h:add_quantization_params)
