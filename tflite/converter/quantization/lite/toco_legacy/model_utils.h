...
// LINT.ThenChange(//tflite/tools/optimize/model_utils.h:MakeDequantizeOperator)
...
// LINT.ThenChange(//tflite/tools/optimize/model_utils.h:MakeTensor)

// LINT.IfChange(HasMinMax)
bool HasMinMax(const TensorT* tensor);
// LINT.ThenChange(//tflite/tools/optimize/model_utils.h:HasMinMax)
