...
// LINT.ThenChange(//depot/google3/third_party/tensorflow/lite/tools/optimize/model_utils.h:MakeDequantizeOperator)
...
// LINT.ThenChange(//depot/google3/third_party/tensorflow/lite/tools/optimize/model_utils.h:MakeTensor)

// LINT.IfChange(HasMinMax)
bool HasMinMax(const TensorT* tensor);
// LINT.ThenChange(//depot/google3/third_party/tensorflow/lite/tools/optimize/model_utils.h:HasMinMax)
