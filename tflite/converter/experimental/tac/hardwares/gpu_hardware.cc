...
#include "tflite/converter/experimental/tac/hardwares/gpu_hardware.h"
...
#include "tflite/converter/experimental/tac/transforms/device_transform_patterns.h"
#include "tflite/converter/ir/tfl_ops.h"
#include "tflite/converter/utils/arithmetic_count_util.h"

namespace mlir {
namespace TFL {
namespace tac {
namespace {
#include "tflite/converter/experimental/tac/transforms/generated_transform_patterns.inc"
}  // namespace
