...
from tflite.profiling.proto import model_runtime_info_pb2  # pylint: disable=unused-import
...
from tflite.python.convert import convert_graphdef as _convert_graphdef
...
from tflite.python.convert import convert_mlir_bytecode as _convert_mlir_bytecode
...
from tflite.python.convert import flatbuffer_to_mlir as _flatbuffer_to_mlir
...
from tflite.python.convert import mlir_to_flatbuffer as _mlir_to_flatbuffer
...
from tflite.python.util import convert_debug_info_func as _convert_debug_info_func
from tflite.python.util import freeze_graph as _freeze_graph
from tflite.python.util import get_debug_info as _get_debug_info
from tflite.python.util import get_grappler_config as _get_grappler_config
from tflite.python.util import get_model_hash as _get_model_hash
from tflite.python.util import get_save_spec as _get_save_spec
from tflite.python.util import get_sparsity_modes as _get_sparsity_modes
from tflite.python.util import get_tensor_name as _get_tensor_name
from tflite.python.util import get_tensors_from_tensor_names as _get_tensors_from_tensor_names
from tflite.python.util import get_tf_type_name as _get_tf_type_name
from tflite.python.util import is_frozen_graph as _is_frozen_graph
from tflite.python.util import model_input_signature as _model_input_signature
from tflite.python.util import modify_model_io_type as _modify_model_io_type
from tflite.python.util import populate_conversion_metadata as _populate_conversion_metadata
from tflite.python.util import run_graph_optimizations as _run_graph_optimizations
