...
public final class GpuDelegateTest {
  ...
  private static final String MODEL_PATH = "third_party/tensorflow/lite/testdata/multi_add.bin";
  ...
  public void testInterpreterWithGpu_QuantModelRunWithDelegate() throws Exception {
    ByteBuffer img =
        TestUtils.getTestImageAsByteBuffer(
            "third_party/tensorflow/lite/java/src/testdata/grace_hopper_224.jpg");
