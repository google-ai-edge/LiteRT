...
public final class NativeInterpreterWrapperTest {
  ...
  private static final String FLOAT_MODEL_PATH =
      "third_party/tensorflow/lite/java/src/testdata/add.bin";

  private static final String INT_MODEL_PATH =
      "third_party/tensorflow/lite/java/src/testdata/int32.bin";

  private static final String LONG_MODEL_PATH =
      "third_party/tensorflow/lite/java/src/testdata/int64.bin";

  private static final String BYTE_MODEL_PATH =
      "third_party/tensorflow/lite/java/src/testdata/uint8.bin";

  private static final String STRING_MODEL_PATH =
      "third_party/tensorflow/lite/java/src/testdata/string.bin";

  private static final String STRING_SCALAR_MODEL_PATH =
      "third_party/tensorflow/lite/java/src/testdata/string_scalar.bin";

  private static final String INVALID_MODEL_PATH =
      "third_party/tensorflow/lite/java/src/testdata/invalid_model.bin";

  private static final String MODEL_WITH_CUSTOM_OP_PATH =
      "third_party/tensorflow/lite/java/src/testdata/with_custom_op.lite";

  private static final String NONEXISTING_MODEL_PATH =
      "third_party/tensorflow/lite/java/src/testdata/nonexisting_model.bin";
