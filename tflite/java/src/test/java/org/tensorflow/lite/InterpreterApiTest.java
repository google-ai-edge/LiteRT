...
public final class InterpreterApiTest {
  ...
  private static final String MODEL_PATH = "third_party/tensorflow/lite/java/src/testdata/add.bin";
  ...
  private static final String UNKNOWN_DIMS_MODEL_PATH =
      "third_party/tensorflow/lite/java/src/testdata/add_unknown_dimensions.bin";
  private static final String DYNAMIC_SHAPES_MODEL_PATH =
      "third_party/tensorflow/lite/testdata/dynamic_shapes.bin";
  private static final String BOOL_MODEL =
      "third_party/tensorflow/lite/java/src/testdata/tile_with_bool_input.bin";
  private static final String MODEL_WITH_SIGNATURE_PATH =
      "third_party/tensorflow/lite/java/src/testdata/mul_add_signature_def.bin";
  private static final String MODEL_WITH_MULTI_SIGNATURE_PATH =
      "third_party/tensorflow/lite/java/src/testdata/multi_signature_def.bin";
