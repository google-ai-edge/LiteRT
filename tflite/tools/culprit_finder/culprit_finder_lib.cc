...
#include "tflite/tools/culprit_finder/culprit_finder_lib.h"
...
#include "tflite/tools/culprit_finder/culprit_finder_utils.h"
#include "tflite/tools/culprit_finder/interpreter_handler.h"
#include "tflite/tools/culprit_finder/model_metadata_lib.h"
...
TfLiteStatus CulpritFinder::RunCulpritFinder() {
  ...
  auto status = RunCulpritFinderBinarySearch();
