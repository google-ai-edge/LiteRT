...
from tflite.tools.optimize.python import modify_model_interface_constants as mmi_constants
from tflite.tools.optimize.python import modify_model_interface_lib as mmi_lib
