...
def tflite_model_test(
    ...
    tf_cc_test(
        name = name,
        size = size,
        srcs = ["//tflite/testing:tflite_diff_example_test.cc"],
        args = diff_args,
        data = [
            tensorflow_model_file,
            tflite_model_file,
        ...
        deps = [
            ...
            "//tflite/testing:tflite_diff_flags",
            "//tflite/testing:tflite_diff_util",
        ],
    )
...
def make_tflite_files(
    ...
    tool = "//tflite/python:tflite_convert"
    cmd = ("$(location %s) " +
    ...
    native.genrule(
        ...
        tools = [tool],
        visibility = ["//tflite/testing:__subpackages__"],
    )
