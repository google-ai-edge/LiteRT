...
#ifndef TENSORFLOW_LITE_TESTING_FUZZING_ONE_OP_FUZZ_MODEL_H_
#define TENSORFLOW_LITE_TESTING_FUZZING_ONE_OP_FUZZ_MODEL_H_
...
#endif  // TENSORFLOW_LITE_TESTING_FUZZING_ONE_OP_FUZZ_MODEL_H_
