...
#ifndef TENSORFLOW_LITE_TESTING_FUZZING_FUZZER_QUOTA_ALLOCATOR_H_
#define TENSORFLOW_LITE_TESTING_FUZZING_FUZZER_QUOTA_ALLOCATOR_H_
...
#endif  // TENSORFLOW_LITE_TESTING_FUZZING_FUZZER_QUOTA_ALLOCATOR_H_
