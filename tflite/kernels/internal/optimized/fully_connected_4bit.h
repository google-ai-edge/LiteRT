...
#include "tflite/kernels/internal/optimized/4bit/sse_fully_connected.h"  // IWYU pragma: export
#elif defined(FC_4BIT_NEON) && (defined(__ARM_NEON__) || defined(__ARM_NEON))
#include "tflite/kernels/internal/optimized/4bit/neon_fully_connected.h"  // IWYU pragma: export
#else
#include "tflite/kernels/internal/optimized/4bit/fully_connected_reference.h"  // IWYU pragma: export
#endif
