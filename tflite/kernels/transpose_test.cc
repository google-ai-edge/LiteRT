...
#include "tflite/kernels/transpose_test_utils.h"
...
TEST(TransposeTest, TestUnequalPermSize) {
  EXPECT_DEATH(TransposeOpConstModel<float>({1, 3, 3, 1}, {2}, {2, 2}),
               "2 != 4");
}
...
TEST(TransposeTest, Test7DInputTensor) {
  EXPECT_DEATH(TransposeOpConstModel<int32_t>({1, 2, 3, 4, 5, 6, 7}, {6},
                                              {0, 1, 2, 3, 4, 5}),
