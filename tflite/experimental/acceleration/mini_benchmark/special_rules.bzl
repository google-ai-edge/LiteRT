...
def libjpeg_hdrs_deps():
    ...
    return [clean_dep("@org_tensorflow//tensorflow/core/platform:jpeg")]
...
def libjpeg_handle_deps():
    ...
    return [clean_dep("//tflite/experimental/acceleration/mini_benchmark:libjpeg_handle_static_link")]

def minibenchmark_visibility_allowlist():
    """Returns a list of packages that can depend on mini_benchmark."""
    return [
        "//tflite/core/experimental/acceleration/mini_benchmark/c:__subpackages__",
        "//tflite/tools/benchmark/experimental/delegate_performance:__subpackages__",
    ]

def register_selected_ops_deps():
    """Return a list of dependencies for registering selected ops."""
    return [
        clean_dep("//tflite/tools/benchmark:register_custom_op"),
    ]
