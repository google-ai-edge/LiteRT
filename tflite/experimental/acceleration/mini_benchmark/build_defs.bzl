...
def cc_library_with_forced_in_process_benchmark_variant(
    ...
    cc_library(
        ...
        deps = deps + in_process_deps + _concat([select(map) for map in non_in_process_deps_selects]) + [
            "//tflite/experimental/acceleration/mini_benchmark:tflite_acceleration_in_process_default",
        ],
        **kwargs
    )
    ...
    cc_library(
        ...
        deps = deps + in_process_deps_renamed + forced_in_process_deps + [
            "//tflite/experimental/acceleration/mini_benchmark:tflite_acceleration_in_process_enable",
        ],
        **kwargs
    )
