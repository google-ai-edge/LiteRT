...
load("//tflite/experimental/litert/build_common:litert_build_defs.bzl", "append_rule_kwargs", "litert_bin", "litert_lib", "make_rpaths")

_QNN_LIBCC_X86_64 = [
    # copybara:uncomment_begin(google-only)
    # "@org_tensorflow//third_party/qairt/latest:lib/x86_64-linux-clang/libc++.so.1",
    # "@org_tensorflow//third_party/qairt/latest:lib/x86_64-linux-clang/libc++abi.so.1",
...
_QNN_LIB_HTP_X86_64 = [
    # copybara:uncomment_begin(google-only)
    # "@org_tensorflow//third_party/qairt/latest:lib/x86_64-linux-clang/libQnnHtp.so",
    # copybara:uncomment_end
]

_QNN_LIB_SYSTEM_X86_64 = [
    # copybara:uncomment_begin(google-only)
    # "@org_tensorflow//third_party/qairt/latest:lib/x86_64-linux-clang/libQnnSystem.so",
    # copybara:uncomment_end
]
