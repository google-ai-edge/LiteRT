...
load("//tflite/experimental/litert/build_common:litert_build_defs.bzl", "absolute_label")
...
LITERT_CORE_LIBS = [
    "//tflite/experimental/litert/c:libLiteRtRuntimeCApi.so",
]
...
QUALCOMM_LIB_SPEC = make_lib_spec(
    core_libs = [
        "@org_tensorflow//third_party/qairt/latest:lib/aarch64-android/libQnnHtp.so",
        "@org_tensorflow//third_party/qairt/latest:lib/aarch64-android/libQnnHtpV75Stub.so",
        "@org_tensorflow//third_party/qairt/latest:lib/aarch64-android/libQnnSystem.so",
        "@org_tensorflow//third_party/qairt/latest:lib/aarch64-android/libQnnHtpPrepare.so",
    ],
    kernel_libs = ["@org_tensorflow//third_party/qairt/latest:lib/hexagon-v75/unsigned/libQnnHtpV75Skel.so"],
    dispatch_lib = "//tflite/experimental/litert/vendors/qualcomm/dispatch:dispatch_api_so",
    compiler_lib = "//tflite/experimental/litert/vendors/qualcomm/compiler:qnn_compiler_plugin_so",
)
...
def get_driver():
    return if_oss(
        "//tflite/experimental/litert/integration_test:run_on_device_driver_OSS",
        "//tflite/experimental/litert/integration_test/google:run_on_device_driver",
    )
...
def litert_integration_test(
    ...
    driver = get_driver()
    target = "//tflite/experimental/litert/integration_test:gen_device_test"
