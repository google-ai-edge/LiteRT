...
def tflite_flex_cc_library(
    ...
    if models:
        ...
        cc_library(
            ...
            srcs = if_mobile([
                clean_dep("@org_tensorflow//tensorflow/core/ops:mobile_srcs"),
                clean_dep("@org_tensorflow//tensorflow/core/kernels:portable_core_ops_srcs"),
            ...
            hdrs = flex_portable_tensorflow_hdrs() + [
                clean_dep("@org_tensorflow//tensorflow/core/ops:mobile_hdrs"),
                clean_dep("@org_tensorflow//tensorflow/core/kernels:portable_core_ops_hdrs"),
                clean_dep("@org_tensorflow//tensorflow/core/kernels:portable_extended_ops_headers"),
                clean_dep("@org_tensorflow//tensorflow/core/kernels:portable_quantized_ops_hdrs"),
            ],
