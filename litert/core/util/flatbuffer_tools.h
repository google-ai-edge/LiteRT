...
#ifndef ODML_LITERT_LITERT_CORE_UTIL_FLATBUFFER_TOOLS_H_
#define ODML_LITERT_LITERT_CORE_UTIL_FLATBUFFER_TOOLS_H_
...
#endif  // ODML_LITERT_LITERT_CORE_UTIL_FLATBUFFER_TOOLS_H_
