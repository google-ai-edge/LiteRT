...
#ifndef ODML_LITERT_LITERT_CORE_MODEL_IR_ALLOCATOR_H_
#define ODML_LITERT_LITERT_CORE_MODEL_IR_ALLOCATOR_H_
...
#endif  // ODML_LITERT_LITERT_CORE_MODEL_IR_ALLOCATOR_H_
