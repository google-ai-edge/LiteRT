...
#ifndef ODML_LITERT_LITERT_CORE_MODEL_BUFFER_MANAGER_H_
#define ODML_LITERT_LITERT_CORE_MODEL_BUFFER_MANAGER_H_
...
#endif  // ODML_LITERT_LITERT_CORE_MODEL_BUFFER_MANAGER_H_
