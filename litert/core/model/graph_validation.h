...
#ifndef ODML_LITERT_LITERT_CORE_MODEL_GRAPH_VALIDATION_H_
#define ODML_LITERT_LITERT_CORE_MODEL_GRAPH_VALIDATION_H_
...
#endif  // ODML_LITERT_LITERT_CORE_MODEL_GRAPH_VALIDATION_H_
