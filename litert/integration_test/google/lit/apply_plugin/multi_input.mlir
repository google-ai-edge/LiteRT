...
// CHECK: func.func @main(%arg0: tensor<2x2xf32> {tf_saved_model.index_path = ["arg0"]}, %arg1: tensor<f32> {tf_saved_model.index_path = ["arg1"]}) -> (tensor<2x2xf32> {tf_saved_model.index_path = ["tfl.add1"]}) attributes {tf.entry_function = {inputs = "arg0,arg1", outputs = "tfl.add1"}, tf_saved_model.exported_names = ["<placeholder signature>"]} {
// CHECK:     %0 = tfl.add %arg0, %arg0 {fused_activation_function = "NONE"} : tensor<2x2xf32>
// CHECK:     %1 = "tfl.custom"(%arg1, %0) <{custom_code = {{.*}}, custom_option = #tfl<const_bytes : "{{.*}}">}> : (tensor<f32>, tensor<2x2xf32>) -> tensor<2x2xf32>
// CHECK:     %2 = tfl.add %1, %1 {fused_activation_function = "NONE"} : tensor<2x2xf32>
// CHECK:     return %2 : tensor<2x2xf32>

// CHECK: func.func private @fn_1(%arg0: tensor<f32>, %arg1: tensor<2x2xf32>) -> tensor<2x2xf32>
// CHECK:     %0 = tfl.mul(%arg1, %arg0) <{fused_activation_function = "NONE"}> : (tensor<2x2xf32>, tensor<f32>) -> tensor<2x2xf32>
