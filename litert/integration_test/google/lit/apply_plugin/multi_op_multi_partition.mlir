...
// CHECK:  func.func private @fn_2(%arg0: tensor<2x2xf32>, %arg1: tensor<2x2xf32>) -> tensor<2x2xf32> {
// CHECK:    %0 = tfl.sub %arg0, %arg1 {fused_activation_function = "NONE"} : tensor<2x2xf32>
// CHECK:    %1 = tfl.sub %0, %arg1 {fused_activation_function = "NONE"} : tensor<2x2xf32>
