...
#
# Example:
# ./run_on_device_driver.sh --bin=path/to/my/binary --data=path/to/data1.txt,path/to/data2.txt --do_exec=true --exec_args="--arg1~--arg2" --exec_env_vars="VAR1=value1,VAR2=value2"
#
# Args are normally supplied / auto generated by bazel build used to run
