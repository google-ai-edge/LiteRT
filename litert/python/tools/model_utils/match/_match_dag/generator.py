...
from litert.python.tools.model_utils.core import tblgen
...
class _ErrorListener(antlr4.error.ErrorListener.ErrorListener):
  """Antlr4 ErrorListener for Match DAG parser."""
...
class MatchDagCodeGenBuilder(tblgen.Visitor):
  """Antlr4 visitor for DAG matching code/instructions generation."""
