...
struct ConversionConfig {
  ...
  std::string model_flags_proto_txt_raw;
  std::string converter_flags_proto_txt_raw;
  std::string input_contents_txt_raw;
  std::string debug_info_txt_raw;
  ModelType original_model_type;

  // Flags
  bool experimental_enable_composite_direct_lowering = false;
  bool experimental_enable_dynamic_update_slice = false;
  std::string experimental_qdq_conversion_mode;
  bool extended_return = false;
  std::string model_origin_framework;
};
