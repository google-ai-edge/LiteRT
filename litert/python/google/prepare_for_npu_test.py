...
from google3.third_party.odml.litert.litert.python.google import prepare_for_npu
...
class PrepareForNpuTest(test_common.TestWithTfliteModels):
  ...
  def test_prepare_for_example_npu(
    ...
    output_path = prepare_for_npu.prepare_for_npu(
        model_path,
        self.output_dir(),
    ...
    self.assertTrue(common.is_tflite(output_path))
