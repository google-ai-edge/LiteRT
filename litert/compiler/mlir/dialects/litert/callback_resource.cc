...
CallbackResourceManager& GetGlobalCallbackResourceManager() {
  static absl::NoDestructor<CallbackResourceManager> kCallbackResourceManager;
  return *kCallbackResourceManager;
}
...
CallbackResourceManagerDialectInterface::
    ...
    : Base(dialect), manager_(GetGlobalCallbackResourceManager()) {}
