...
// Taken from tflite/core/c/common.h
...
class Translator {
 public:
  ...
  static absl::Status Translate(ModuleOp module,
                                const litert::FlatbufferExportOptions& options,
 ...
 private:
  ...
  explicit Translator(
      ...
      const std::vector<litert::FlatbufferExportAttributeBufferApplierFactory>&
  ...
  std::vector<litert::FlatbufferExportAttributeBufferApplierFactory>
      attribute_buffer_applier_factories_;
...
std::optional<BufferOffset<tflite::Buffer>> Translator::BuildBuffer(
  ...
  litert::FlatbufferExportAttributeBufferApplier applier = nullptr;
...
absl::Status Translator::Translate(
    ModuleOp module, const litert::FlatbufferExportOptions& options,
    llvm::raw_pwrite_stream& export_stream) {
