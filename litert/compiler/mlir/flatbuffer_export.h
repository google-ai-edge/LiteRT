...
#ifndef THIRD_PARTY_ODML_LITERT_LITERT_COMPILER_MLIR_FLATBUFFER_EXPORT_H_
#define THIRD_PARTY_ODML_LITERT_LITERT_COMPILER_MLIR_FLATBUFFER_EXPORT_H_
...
#endif  // THIRD_PARTY_ODML_LITERT_LITERT_COMPILER_MLIR_FLATBUFFER_EXPORT_H_
