...
#ifndef THIRD_PARTY_ODML_LITERT_LITERT_ATS_REGISTER_SLICE_H_
#define THIRD_PARTY_ODML_LITERT_LITERT_ATS_REGISTER_SLICE_H_
...
#endif  // THIRD_PARTY_ODML_LITERT_LITERT_ATS_REGISTER_SLICE_H_
