...
void RegisterNoOpImpl(const AtsConf& options, size_t& test_id, size_t iters,
...
void RegisterNoOp(const AtsConf& options, size_t& test_id, size_t iters,
  ...
  RegisterNoOpImpl<AtsInferenceTest>(options, test_id, iters, cap);
}

void RegisterNoOp(const AtsConf& options, size_t& test_id, size_t iters,
                  AtsCompileTest::Capture& cap) {
  RegisterNoOpImpl<AtsCompileTest>(options, test_id, iters, cap);
}
