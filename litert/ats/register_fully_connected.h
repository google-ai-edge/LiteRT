...
#ifndef THIRD_PARTY_ODML_LITERT_LITERT_ATS_REGISTER_FULLY_CONNECTED_H_
#define THIRD_PARTY_ODML_LITERT_LITERT_ATS_REGISTER_FULLY_CONNECTED_H_
...
#endif  // THIRD_PARTY_ODML_LITERT_LITERT_ATS_REGISTER_FULLY_CONNECTED_H_
