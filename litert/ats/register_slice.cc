...
#include "litert/ats/register_slice.h"
...
#include "litert/test/generators/slice.h"
...
void RegisterSliceImpl(const AtsConf& options, size_t& test_id, size_t iters,
...
void RegisterSlice(const AtsConf& options, size_t& test_id, size_t iters,
  ...
  RegisterSliceImpl<AtsInferenceTest>(options, test_id, iters, cap);
}

void RegisterSlice(const AtsConf& options, size_t& test_id, size_t iters,
                   AtsCompileTest::Capture& cap) {
  RegisterSliceImpl<AtsCompileTest>(options, test_id, iters, cap);
}
