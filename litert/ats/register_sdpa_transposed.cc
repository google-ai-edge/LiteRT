...
#include "litert/test/generators/sdpa_transposed.h"
...
void RegisterSdpaTransposedImpl(const AtsConf& options, size_t& test_id,
...
void RegisterSdpaTransposed(const AtsConf& options, size_t& test_id,
                            size_t iters, AtsInferenceTest::Capture& cap) {
  RegisterSdpaTransposedImpl<AtsInferenceTest>(options, test_id, iters, cap);
}

void RegisterSdpaTransposed(const AtsConf& options, size_t& test_id,
                            size_t iters, AtsCompileTest::Capture& cap) {
  RegisterSdpaTransposedImpl<AtsCompileTest>(options, test_id, iters, cap);
}
