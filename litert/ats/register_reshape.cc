...
#include "litert/test/generators/reshape.h"

namespace litert::testing {
namespace {

template <typename Fixture>
void RegisterReshapeImpl(const AtsConf& options, size_t& test_id, size_t iters,
...
void RegisterReshape(const AtsConf& options, size_t& test_id, size_t iters,
  ...
  RegisterReshapeImpl<AtsInferenceTest>(options, test_id, iters, cap);
}

void RegisterReshape(const AtsConf& options, size_t& test_id, size_t iters,
                     AtsCompileTest::Capture& cap) {
  RegisterReshapeImpl<AtsCompileTest>(options, test_id, iters, cap);
}
