...
#include "litert/test/generators/conv_2d.h"
...
void RegisterConv2dImpl(const AtsConf& options, size_t& test_id, size_t iters,
...
void RegisterConv2d(const AtsConf& options, size_t& test_id, size_t iters,
  ...
  RegisterConv2dImpl<AtsInferenceTest>(options, test_id, iters, cap);
}

void RegisterConv2d(const AtsConf& options, size_t& test_id, size_t iters,
                    AtsCompileTest::Capture& cap) {
  RegisterConv2dImpl<AtsCompileTest>(options, test_id, iters, cap);
}
