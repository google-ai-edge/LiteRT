...
#ifndef THIRD_PARTY_ODML_LITERT_LITERT_ATS_REGISTER_SDPA_H_
#define THIRD_PARTY_ODML_LITERT_LITERT_ATS_REGISTER_SDPA_H_
...
#endif  // THIRD_PARTY_ODML_LITERT_LITERT_ATS_REGISTER_SDPA_H_
