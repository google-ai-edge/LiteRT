...
TEST_F(SdpaTest, ReferenceSimpleIdentityAttention) {
  ...
  LITERT_ASSERT_OK_AND_ASSIGN(auto q,
                              SimpleBuffer::Create<float>({1, 1, 1, 2}));
  LITERT_ASSERT_OK_AND_ASSIGN(auto k,
                              SimpleBuffer::Create<float>({1, 1, 1, 2}));
  LITERT_ASSERT_OK_AND_ASSIGN(auto v,
                              SimpleBuffer::Create<float>({1, 1, 1, 2}));
  ...
  LITERT_ASSERT_OK_AND_ASSIGN(auto out,
                              SimpleBuffer::Create<float>({1, 1, 1, 2}));
  VarBuffers outputs;
...
TEST_F(SdpaTest, ReferenceCausalMask) {
  ...
  LITERT_ASSERT_OK_AND_ASSIGN(auto q,
                              SimpleBuffer::Create<float>({1, 2, 1, 1}));
  LITERT_ASSERT_OK_AND_ASSIGN(auto k,
                              SimpleBuffer::Create<float>({1, 2, 1, 1}));
  LITERT_ASSERT_OK_AND_ASSIGN(auto v,
                              SimpleBuffer::Create<float>({1, 2, 1, 1}));
  LITERT_ASSERT_OK_AND_ASSIGN(auto mask,
                              SimpleBuffer::Create<float>({1, 1, 2, 2}));
...
TEST_F(SdpaTest, ReferenceSoftcap) {
  ...
  LITERT_ASSERT_OK_AND_ASSIGN(auto q,
                              SimpleBuffer::Create<float>({1, 1, 1, 1}));
  LITERT_ASSERT_OK_AND_ASSIGN(auto k,
                              SimpleBuffer::Create<float>({1, 1, 1, 1}));
  LITERT_ASSERT_OK_AND_ASSIGN(auto v,
                              SimpleBuffer::Create<float>({1, 1, 1, 1}));
...
TEST_F(SdpaTest, ReferenceFp16Half) {
  ...
  LITERT_ASSERT_OK_AND_ASSIGN(auto q,
                              SimpleBuffer::Create<tflite::half>({1, 1, 1, 2}));
  LITERT_ASSERT_OK_AND_ASSIGN(auto k,
                              SimpleBuffer::Create<tflite::half>({1, 1, 1, 2}));
  LITERT_ASSERT_OK_AND_ASSIGN(auto v,
                              SimpleBuffer::Create<tflite::half>({1, 1, 1, 2}));
