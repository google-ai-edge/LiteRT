...
+ (void)checkTensorBufferFloatOutput:(litert::TensorBuffer *)output_buffer
                  withExpectedOutput:(const float *)expected_output
...
// @param expected_output The expected output values.
// @param elementCount The number of elements in the output buffer and expected output.
+ (void)checkTensorBufferInt32Output:(litert::TensorBuffer *)output_buffer
                  withExpectedOutput:(const int32_t *)expected_output
                    withElementCount:(size_t)element_count;
@end
