...
func.func @main(%arg0: tensor<1x128x2304xf32>, %arg1: tensor<2304xf32>) -> tensor<1x128x2304xf32> {
  %0 = tfl.add %arg0, %arg0 {fused_activation_function = "NONE"} : tensor<1x128x2304xf32>
  %1 = stablehlo.composite "odml.rms_norm" %0, %arg1 {composite_attributes = {epsilon = 9.99999997E-7 : f32}, decomposition = @odml.rms_norm.impl} : (tensor<1x128x2304xf32>, tensor<2304xf32>) -> tensor<1x128x2304xf32>
  %2 = tfl.mul %1, %arg0 {fused_activation_function = "NONE"} : tensor<1x128x2304xf32>
  return %2 : tensor<1x128x2304xf32>
}
