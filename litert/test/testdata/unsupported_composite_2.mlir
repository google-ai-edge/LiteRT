...
func.func @main(%arg0: tensor<1x128x128xf32>, %arg1: tensor<1x128x128xf32>) -> tensor<1x128x128xf32> {
  %0 = stablehlo.composite "unsupported.composite" %arg0, %arg1 {composite_attributes = {}, decomposition = @unsupported.composite.impl}: (tensor<1x128x128xf32>, tensor<1x128x128xf32>) -> tensor<1x128x128xf32>
...
func.func @unsupported.composite.impl(%arg0: tensor<1x128x128xf32>, %arg1: tensor<1x128x128xf32>) -> tensor<1x128x128xf32> {
    ...
    %2 = tfl.div %0, %1 {fused_activation_function = "NONE"} : tensor<1x128x128xf32>
