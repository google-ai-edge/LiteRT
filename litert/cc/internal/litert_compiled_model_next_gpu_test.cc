...
class CompiledModelNextGpuTest : public ::testing::TestWithParam<bool> {};

TEST_P(CompiledModelNextGpuTest, WithProfiler) {
...
INSTANTIATE_TEST_SUITE_P(CompiledModelNextGpuTest, CompiledModelNextGpuTest,
