...
TEST(CompiledModelNextTest, Basic) {
  // Environment setup.
...
TEST(CompiledModelNextTest, WithProfiler) {
  // Environment setup.
  LITERT_ASSERT_OK_AND_ASSIGN(Environment env, litert::Environment::Create({}));
...
TEST(CompiledModelNextTest, DispatchAnnotationsWithSignatureName) {
  // Environment setup.
  LITERT_ASSERT_OK_AND_ASSIGN(Environment env, litert::Environment::Create({}));
...
TEST(CompiledModelNextTest, DispatchAnnotationsInvalidSignature) {
  // Environment setup.
  LITERT_ASSERT_OK_AND_ASSIGN(Environment env, litert::Environment::Create({}));
