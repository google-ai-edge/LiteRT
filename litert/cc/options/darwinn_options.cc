...
Expected<DarwinnDeviceOptions> DarwinnDeviceOptions::Create(
  ...
  LITERT_RETURN_IF_ERROR(original_identifier == Identifier(),
      ...
      << "Cannot create DarwiNN device options from an opaque options object "
         "that doesn't "
...
Expected<void> DarwinnDeviceOptions::SetEnableMultipleSubgraphs(bool enable) {
  ...
  LITERT_RETURN_IF_ERROR(
      LiteRtFindDarwinnDeviceOptions(Get(), &darwinn_options));
  LITERT_RETURN_IF_ERROR(
      LiteRtSetDarwinnEnableMultipleSubgraphs(darwinn_options, enable));
  return {};
}
...
Expected<bool> DarwinnDeviceOptions::GetEnableMultipleSubgraphs() const {
  ...
  bool enable = false;
  LITERT_RETURN_IF_ERROR(
      LiteRtGetDarwinnEnableMultipleSubgraphs(darwinn_options, &enable));
  return enable;
}

Expected<void> DarwinnDeviceOptions::SetCompileIfResize(
    bool compile_if_resize) {
  LiteRtDarwinnDeviceOptions darwinn_options;
  LITERT_RETURN_IF_ERROR(
      LiteRtFindDarwinnDeviceOptions(Get(), &darwinn_options));
  LITERT_RETURN_IF_ERROR(
      LiteRtSetDarwinnCompileIfResize(darwinn_options, compile_if_resize));
  return {};
}
...
Expected<bool> DarwinnDeviceOptions::GetCompileIfResize() const {
  ...
  LITERT_RETURN_IF_ERROR(
      LiteRtGetDarwinnCompileIfResize(darwinn_options, &compile_if_resize));
  return compile_if_resize;
}

Expected<void> DarwinnDeviceOptions::SetAllowCpuFallback(
    bool allow_cpu_fallback) {
  LiteRtDarwinnDeviceOptions darwinn_options;
  LITERT_RETURN_IF_ERROR(
      LiteRtFindDarwinnDeviceOptions(Get(), &darwinn_options));
  LITERT_RETURN_IF_ERROR(
      LiteRtSetDarwinnAllowCpuFallback(darwinn_options, allow_cpu_fallback));
  return {};
}
...
Expected<bool> DarwinnDeviceOptions::GetAllowCpuFallback() const {
  ...
  LITERT_RETURN_IF_ERROR(
      LiteRtGetDarwinnAllowCpuFallback(darwinn_options, &allow_cpu_fallback));
...
Expected<void> DarwinnDeviceOptions::SetSkipOpFilter(bool skip_op_filter) {
  ...
  LITERT_RETURN_IF_ERROR(
      LiteRtFindDarwinnDeviceOptions(Get(), &darwinn_options));
  LITERT_RETURN_IF_ERROR(
      LiteRtSetDarwinnSkipOpFilter(darwinn_options, skip_op_filter));
  return {};
}
...
Expected<bool> DarwinnDeviceOptions::GetSkipOpFilter() const {
  ...
  LITERT_RETURN_IF_ERROR(
      LiteRtGetDarwinnSkipOpFilter(darwinn_options, &skip_op_filter));
...
Expected<void> DarwinnDeviceOptions::SetNumInterpreters(int num_interpreters) {
  ...
  LITERT_RETURN_IF_ERROR(
      LiteRtFindDarwinnDeviceOptions(Get(), &darwinn_options));
  LITERT_RETURN_IF_ERROR(
      LiteRtSetDarwinnNumInterpreters(darwinn_options, num_interpreters));
  return {};
}
...
Expected<int> DarwinnDeviceOptions::GetNumInterpreters() const {
  ...
  LITERT_RETURN_IF_ERROR(
      LiteRtGetDarwinnNumInterpreters(darwinn_options, &num_interpreters));
  return num_interpreters;
}

Expected<void> DarwinnDeviceOptions::SetRegisterGraphDuringModify(
    bool register_graph) {
  LiteRtDarwinnDeviceOptions darwinn_options;
  LITERT_RETURN_IF_ERROR(
      LiteRtFindDarwinnDeviceOptions(Get(), &darwinn_options));
  LITERT_RETURN_IF_ERROR(LiteRtSetDarwinnRegisterGraphDuringModify(
      darwinn_options, register_graph));
  return {};
}
...
Expected<bool> DarwinnDeviceOptions::GetRegisterGraphDuringModify() const {
  ...
  LITERT_RETURN_IF_ERROR(LiteRtGetDarwinnRegisterGraphDuringModify(
      darwinn_options, &register_graph));
...
Expected<void> DarwinnDeviceOptions::SetInKernelFence(bool in_kernel_fence) {
  ...
  LITERT_RETURN_IF_ERROR(
      LiteRtFindDarwinnDeviceOptions(Get(), &darwinn_options));
  LITERT_RETURN_IF_ERROR(
      LiteRtSetDarwinnInKernelFence(darwinn_options, in_kernel_fence));
  return {};
}
...
Expected<bool> DarwinnDeviceOptions::GetInKernelFence() const {
  ...
  LITERT_RETURN_IF_ERROR(
      LiteRtGetDarwinnInKernelFence(darwinn_options, &in_kernel_fence));
...
Expected<void> DarwinnDeviceOptions::SetGraphBuffersDonatable(bool donatable) {
  ...
  LITERT_RETURN_IF_ERROR(
      LiteRtFindDarwinnDeviceOptions(Get(), &darwinn_options));
  LITERT_RETURN_IF_ERROR(
      LiteRtSetDarwinnGraphBuffersDonatable(darwinn_options, donatable));
  return {};
}
...
Expected<bool> DarwinnDeviceOptions::GetGraphBuffersDonatable() const {
  ...
  LITERT_RETURN_IF_ERROR(
      LiteRtGetDarwinnGraphBuffersDonatable(darwinn_options, &donatable));
  return donatable;
}
...
Expected<void> DarwinnDeviceOptions::SetUseTachyon(bool use_tachyon) {
  ...
  LITERT_RETURN_IF_ERROR(
      LiteRtFindDarwinnDeviceOptions(Get(), &darwinn_options));
  LITERT_RETURN_IF_ERROR(
      LiteRtSetDarwinnUseTachyon(darwinn_options, use_tachyon));
  return {};
}
...
Expected<bool> DarwinnDeviceOptions::GetUseTachyon() const {
  ...
  LITERT_RETURN_IF_ERROR(
      LiteRtGetDarwinnUseTachyon(darwinn_options, &use_tachyon));
  return use_tachyon;
}
...
Expected<void> DarwinnDeviceOptions::SetDisableLogInfo(bool disable_log_info) {
  ...
  LITERT_RETURN_IF_ERROR(
      LiteRtFindDarwinnDeviceOptions(Get(), &darwinn_options));
  LITERT_RETURN_IF_ERROR(
      LiteRtSetDarwinnDisableLogInfo(darwinn_options, disable_log_info));
  return {};
}
...
Expected<bool> DarwinnDeviceOptions::GetDisableLogInfo() const {
  ...
  LITERT_RETURN_IF_ERROR(
      LiteRtGetDarwinnDisableLogInfo(darwinn_options, &disable_log_info));
