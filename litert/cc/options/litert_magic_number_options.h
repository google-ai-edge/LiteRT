...
/// it when destroyed.
Expected<MagicNumberConfigsPtr>
CreateMagicNumberConfigs(std::size_t num_configs);
...
/// The returned pointer owns the allocated memory and will automatically free
/// it when destroyed.
Expected<MagicNumberVerificationsPtr>
CreateMagicNumberVerifications(std::size_t num_verifications);

inline Expected<MagicNumberConfigsPtr>
CreateMagicNumberConfigs(std::size_t num_configs) {
...
inline Expected<MagicNumberVerificationsPtr>
CreateMagicNumberVerifications(std::size_t num_verifications) {
