...
TEST(OptionsExperimentalTest, MaxUnpooling2D) {
  ...
  std::string model_path =
      litert::testing::GetTestFilePath("max_unpooling_2d.tflite");
...
TEST(OptionsExperimentalTest, MaxUnpooling2D_Valid) {
  ...
  auto model_path =
      litert::testing::GetTestFilePath("max_unpooling_2d_valid.tflite");
...
TEST(OptionsExperimentalTest, SinhCustomOp) {
  ...
  std::string model_path = litert::testing::GetTestFilePath("custom_sinh.bin");
