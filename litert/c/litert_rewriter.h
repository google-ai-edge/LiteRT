...
// LiteRtRewritePattern (A.K.A Transformation)
typedef LiteRtStatus (*LiteRtPatternFn)(LiteRtOp op, LiteRtRewriter rewriter);

//
// Rewriter Op option builders
//

LiteRtStatus LiteRtRewriterBuildAddOpOption(
    LiteRtOp op, uint32_t* fused_activation, LiteRtRewriter rewriter);
