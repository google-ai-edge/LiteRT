...
LiteRtStatus LiteRtFindDarwinnRuntimeOptions(
  ...
  LITERT_RETURN_IF_ERROR(LiteRtFindOpaqueOptionsData(
      opaque_options, LiteRtGetDarwinnRuntimeOptionsIdentifier(), &options_data));
  
  *runtime_options = reinterpret_cast<LiteRtDarwinnRuntimeOptions>(options_data);
  return kLiteRtStatusOk;
}
...
LiteRtStatus LiteRtGetDarwinnInferencePowerState(
  ...
  auto* opts = reinterpret_cast<const litert::LiteRtDarwinnRuntimeOptionsT*>(options);
...
LiteRtStatus LiteRtSetDarwinnInactivePowerState(
    LiteRtDarwinnRuntimeOptions options, uint32_t power_state) {
  LITERT_RETURN_IF_ERROR(options, litert::ErrorStatusBuilder::InvalidArgument())
      << "options is null.";
  
  auto* opts = reinterpret_cast<litert::LiteRtDarwinnRuntimeOptionsT*>(options);
  opts->inactive_power_state = power_state;
  return kLiteRtStatusOk;
}

LiteRtStatus LiteRtGetDarwinnInactivePowerState(
    LiteRtDarwinnRuntimeOptionsConst options, uint32_t* power_state) {
  LITERT_RETURN_IF_ERROR(options, litert::ErrorStatusBuilder::InvalidArgument())
      << "options is null.";
  LITERT_RETURN_IF_ERROR(power_state,
  ...
  auto* opts = reinterpret_cast<const litert::LiteRtDarwinnRuntimeOptionsT*>(options);
  *power_state = opts->inactive_power_state;
  return kLiteRtStatusOk;
}

LiteRtStatus LiteRtSetDarwinnInactiveMemoryPowerState(
    LiteRtDarwinnRuntimeOptions options, uint32_t memory_power_state) {
  LITERT_RETURN_IF_ERROR(options, litert::ErrorStatusBuilder::InvalidArgument())
      << "options is null.";
  
  auto* opts = reinterpret_cast<litert::LiteRtDarwinnRuntimeOptionsT*>(options);
  opts->inactive_memory_power_state = memory_power_state;
  return kLiteRtStatusOk;
}

LiteRtStatus LiteRtGetDarwinnInactiveMemoryPowerState(
    LiteRtDarwinnRuntimeOptionsConst options, uint32_t* memory_power_state) {
  LITERT_RETURN_IF_ERROR(options, litert::ErrorStatusBuilder::InvalidArgument())
      << "options is null.";
  LITERT_RETURN_IF_ERROR(memory_power_state,
  ...
  auto* opts = reinterpret_cast<const litert::LiteRtDarwinnRuntimeOptionsT*>(options);
  *memory_power_state = opts->inactive_memory_power_state;
  return kLiteRtStatusOk;
}

LiteRtStatus LiteRtSetDarwinnInactiveTimeoutUs(
    LiteRtDarwinnRuntimeOptions options, int64_t timeout_us) {
  LITERT_RETURN_IF_ERROR(options, litert::ErrorStatusBuilder::InvalidArgument())
      << "options is null.";
  
  auto* opts = reinterpret_cast<litert::LiteRtDarwinnRuntimeOptionsT*>(options);
  opts->inactive_timeout_us = timeout_us;
  return kLiteRtStatusOk;
}

LiteRtStatus LiteRtGetDarwinnInactiveTimeoutUs(
    LiteRtDarwinnRuntimeOptionsConst options, int64_t* timeout_us) {
  LITERT_RETURN_IF_ERROR(options, litert::ErrorStatusBuilder::InvalidArgument())
      << "options is null.";
  LITERT_RETURN_IF_ERROR(timeout_us,
                         litert::ErrorStatusBuilder::InvalidArgument())
      << "timeout_us is null.";
  
  auto* opts = reinterpret_cast<const litert::LiteRtDarwinnRuntimeOptionsT*>(options);
  *timeout_us = opts->inactive_timeout_us;
  return kLiteRtStatusOk;
}