...
#if LITERT_ENABLE_DARWINN_OPTIONS
#define LITERT_HAS_DARWINN_OPTIONS_SUPPORT 1
#else
#define LITERT_HAS_DARWINN_OPTIONS_SUPPORT 0
#endif  // LITERT_ENABLE_DARWINN_OPTIONS
