...
typedef LiteRtStatus (*CreateCustomTensorBuffer)(
    ...
    HwMemoryHandle* hw_memory_handle, HwMemoryInfo* hw_memory_info);

// Custom TensorBuffer handler function to destroy a custom TensorBuffer.
typedef LiteRtStatus (*DestroyCustomTensorBuffer)(HwMemoryInfo hw_memory_info);
...
// TensorBuffer.
typedef LiteRtStatus (*LockCustomTensorBuffer)(LiteRtTensorBuffer tensor_buffer,
...
typedef LiteRtStatus (*UnlockCustomTensorBuffer)(
    LiteRtTensorBuffer tensor_buffer, HwMemoryInfo hw_memory_info);
