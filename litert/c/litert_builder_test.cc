...
TEST(LiteRtBuilderTest, BuildTensorRejectsInvalidPointersAndType) {
  LiteRtBuilderT builder;
  LiteRtTensor tensor;
  ...
  EXPECT_EQ(
      LiteRtBuilderBuildTensor(
          nullptr, kLiteRtRankedTensorType, ranked_tensor_type,
  ...
  EXPECT_EQ(
      LiteRtBuilderBuildTensor(
          ...
          LiteRtUnrankedTensorType(), LiteRtWeights(), kLiteRtQuantizationNone,
          LiteRtQuantizationPerTensor(), LiteRtQuantizationPerChannel(),
          LiteRtQuantizationBlockWise(), kName.data(), nullptr),
      kLiteRtStatusErrorInvalidArgument);
  EXPECT_EQ(
      LiteRtBuilderBuildTensor(
          &builder, static_cast<LiteRtTensorTypeId>(999), ranked_tensor_type,
          LiteRtUnrankedTensorType(), LiteRtWeights(), kLiteRtQuantizationNone,
          LiteRtQuantizationPerTensor(), LiteRtQuantizationPerChannel(),
          LiteRtQuantizationBlockWise(), kName.data(), &tensor),
      kLiteRtStatusErrorInvalidArgument);
