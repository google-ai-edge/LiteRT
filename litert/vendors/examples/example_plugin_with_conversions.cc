...
#include "third_party/odml/litert/litert/vendors/cc/partition_with_capabilities.h"
...
#include "third_party/odml/litert/litert/vendors/examples/example_plugin_common.h"
