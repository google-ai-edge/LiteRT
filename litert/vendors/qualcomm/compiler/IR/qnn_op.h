...
#ifndef ODML_LITERT_LITERT_VENDORS_QUALCOMM_COMPILER_IR_QNN_OP_H_
#define ODML_LITERT_LITERT_VENDORS_QUALCOMM_COMPILER_IR_QNN_OP_H_
...
#endif  // ODML_LITERT_LITERT_VENDORS_QUALCOMM_COMPILER_IR_QNN_OP_H_
