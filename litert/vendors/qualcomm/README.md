...
Detailed build instructions can be found in [BUILD_INSTRUCTIONS.md](./doc/BUILD_INSTRUCTIONS.md).

## IoT Instructions 🌐

Detailed IoT instructions can be found in [IOT_INSTRUCTIONS.md](./doc/IOT_INSTRUCTIONS.md).
