...
load("//third_party/odml/litert/litert/build_common:litert_build_defs.bzl", "append_rule_kwargs", "litert_bin", "litert_lib", "make_rpaths")
...
def _litert_with_qnn_base(
    ...
    data = select({
        "//third_party/tensorflow:linux_x86_64": data_x86_64,
        "//conditions:default": [],
    })
    ...
    append_rule_kwargs(
        ...
        data = data,
        linkopts = select({
            "//third_party/tensorflow:linux_x86_64": [make_rpaths(_QNN_LIB_RPATHS_X86_64)],
            "//conditions:default": [],
        }),
    )
