...
# Estabalish soft link to Qualcomm AI Runtime SDK
ln -s ./qairt/2.29.0.241129/ $LiteRT/litert/third_party/qairt/latest
```

2. Uncomment copybara comments before build.
```sh
# uncomment `"//third_party/qairt/latest:qnn_lib_headers",` in BUILD before build
...
## Run all tests
```sh
# Run all tests on x86
$LiteRT/litert/vendors/qualcomm/scripts/run_all_tests_x86.sh
```
