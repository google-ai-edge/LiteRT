...
TEST_P(QnnModelTest, SingleElementWiseDivide) {
  ...
  quant_param_0.emplace<::qnn::ScaleOffsetQuantizeParamsWrapper>(0.000031f, 0);
  quant_param_1.emplace<::qnn::ScaleOffsetQuantizeParamsWrapper>(0.000101f, 0);
  quant_param_2.emplace<::qnn::ScaleOffsetQuantizeParamsWrapper>(0.000030f, 0);
