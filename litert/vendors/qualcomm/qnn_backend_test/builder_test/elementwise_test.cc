...
TEST_P(QnnModelTest, ElementWiseRoundInputOutput) {
  RunUnaryTest<float, float>(
      ...
      QNN_DATATYPE_FLOAT_32, {8.1f, 0.0f, 3.9f, 4.2f, -3.1f, -4.5f},
...
TEST_P(QnnModelTest, ElementWiseHardSwishInputOutput) {
  RunUnaryTest<float, float>(
      ...
      QNN_DATATYPE_FLOAT_32,
      {-4.0f, -3.0f, -2.0f, -1.0f, 0.0f, 1.0f, 2.0f, 3.0f, 6.0f},
      {0.0f, 0.0f, -0.333333f, -0.333333f, 0.0f, 0.666667f, 1.666667f, 3.0f,
       6.0f},
      1e-2f);
}
...
TEST_P(QnnModelTest, GeluInputOutput) {
  RunUnaryTest<float, float>(
      ...
      {0.0f, 0.841345f, 2.99595f, 0.841345f, -0.158655f, -0.0455003f}, 1e-2f);
}
...
TEST_P(QnnModelTest, ElementWiseQuantizedMultiplyInt8InputOutput) {
  RunBinaryTest<std::int8_t, std::int8_t>(
      ...
      {-3, 6, -6, 8}, 0.0f, Int8Quantization(1.0f), Int8Quantization(1.0f));
}
...
TEST_P(QnnModelTest, ElementWiseQuantizedSubtractInt16InputOutput) {
  RunBinaryTest<std::int16_t, std::int16_t>(
      ...
      QNN_DATATYPE_SFIXED_POINT_16, {1, 2, 3, 4}, {4, 3, 2, 1}, {-3, -1, 1, 3},
      0.0f, Int16Quantization(1.0f), Int16Quantization(1.0f));
}
...
TEST_P(QnnModelTest, ElementWiseQuantizedRsqrtInt16InputOutput) {
  RunUnaryTest<std::int16_t, std::int16_t>(
      ...
      QNN_DATATYPE_SFIXED_POINT_16, {1, 4, 16}, {4, 2, 1}, 0.0f,
      Int16Quantization(1.0f), Int16Quantization(0.25f));
}
...
TEST_P(QnnModelTest, ElementWiseQuantizedSinInputOutput) {
  RunUnaryTest<std::int8_t, std::int8_t>(
      ...
      QNN_DATATYPE_SFIXED_POINT_8, {0, 1, -1}, {0, 1, -1}, 0.0f,
      Int8Quantization(1.0f), Int8Quantization(1.0f));
}
...
TEST_P(QnnModelTest, ElementWiseQuantizedSqrtInputOutput) {
  RunUnaryTest<std::int8_t, std::int8_t>(
      ...
      QNN_DATATYPE_SFIXED_POINT_8, {0, 1, 4, 9}, {0, 1, 2, 3}, 0.0f,
      Int8Quantization(1.0f), Int8Quantization(1.0f));
}
...
TEST_P(QnnModelTest, ElementWiseQuantizedFloorInputOutput) {
  RunUnaryTest<std::int8_t, std::int8_t>(
      ...
      QNN_DATATYPE_SFIXED_POINT_8, {-2, -1, 0, 3}, {-2, -1, 0, 3}, 0.0f,
      Int8Quantization(1.0f), Int8Quantization(1.0f));
}
...
TEST_P(QnnModelTest, ElementWiseQuantizedFloorDivInputOutput) {
  RunBinaryTest<std::int8_t, std::int8_t>(
      ...
      {2, -3, -3, 2}, 0.0f, Int8Quantization(1.0f), Int8Quantization(1.0f));
}
...
TEST_P(QnnModelTest, ElementWiseQuantizedExpInputOutput) {
  RunUnaryTest<std::int8_t, std::int8_t>(
      ...
      QNN_DATATYPE_SFIXED_POINT_8, {0, 1, 2}, {1, 3, 7}, 0.0f,
      Int8Quantization(1.0f), Int8Quantization(1.0f));
}
...
TEST_P(QnnModelTest, ElementWiseQuantizedLogInputOutput) {
  RunUnaryTest<std::int8_t, std::int8_t>(
      ...
      QNN_DATATYPE_SFIXED_POINT_8, {1, 3, 7}, {0, 1, 2}, 0.0f,
      Int8Quantization(1.0f), Int8Quantization(1.0f));
}
...
TEST_P(QnnModelTest, ElementWiseQuantizedAbsInputOutput) {
  RunUnaryTest<std::int8_t, std::int8_t>(
      ...
      QNN_DATATYPE_SFIXED_POINT_8, {0, -1, 2, -3}, {0, 1, 2, 3}, 0.0f,
      Int8Quantization(1.0f), Int8Quantization(1.0f));
}
...
TEST_P(QnnModelTest, ElementWiseQuantizedMultiplyUInt8InputOutput) {
  RunBinaryTest<std::uint8_t, std::uint8_t>(
      ...
      QNN_DATATYPE_UFIXED_POINT_8, {127, 130, 126, 129}, {131, 131, 129, 124},
      {125, 134, 126, 124}, 0.0f, UInt8Quantization(), UInt8Quantization());
}
...
TEST_P(QnnModelTest, ElementWiseQuantizedMaximumUInt8InputOutput) {
  RunBinaryTest<std::uint8_t, std::uint8_t>(
      ...
      QNN_DATATYPE_UFIXED_POINT_8, {1, 0, 2, 11, 2, 23}, {0, 0, 1, 12, 255, 1},
      {1, 0, 2, 12, 255, 23}, 0.0f, UInt8Quantization(), UInt8Quantization());
}
...
TEST_P(QnnModelTest, ElementWiseQuantizedMinimumUInt8InputOutput) {
  RunBinaryTest<std::uint8_t, std::uint8_t>(
      ...
      QNN_DATATYPE_UFIXED_POINT_8, {1, 0, 2, 11, 2, 23}, {0, 0, 1, 12, 255, 1},
      {0, 0, 1, 11, 2, 1}, 0.0f, UInt8Quantization(), UInt8Quantization());
}
