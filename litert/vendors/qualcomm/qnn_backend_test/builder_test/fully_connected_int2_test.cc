...
TEST_F(QnnModelTest, FullyConnectedInt2Sanity) {
  SetUpQnnModel(::qnn::Options(), "SM8850");
  float kScale = 0.001;
  ...
  std::vector<uint8_t> int2_weight_data;
  ConvertDataFromInt8ToInt2(weight_data, int2_weight_data);
