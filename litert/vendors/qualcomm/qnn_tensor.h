...
#ifndef ODML_LITERT_LITERT_VENDORS_QUALCOMM_QNN_TENSOR_H_
#define ODML_LITERT_LITERT_VENDORS_QUALCOMM_QNN_TENSOR_H_
...
#endif  // ODML_LITERT_LITERT_VENDORS_QUALCOMM_QNN_TENSOR_H_
