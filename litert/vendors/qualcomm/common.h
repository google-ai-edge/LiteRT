...
inline LiteRtStatus InitQnnOptions(
  ...
  qnn_options.SetCompileCustomOpPackage(
      qualcomm_options.GetCompileCustomOpPackageName(),
      qualcomm_options.GetCompileCustomOpPackagePath(),
      qualcomm_options.GetCompileCustomOpPackageTarget(),
      qualcomm_options.GetCompileCustomOpPackageInterfaceProvider());
  qnn_options.SetDispatchCustomOpPackage(
      qualcomm_options.GetDispatchCustomOpPackageName(),
      qualcomm_options.GetDispatchCustomOpPackagePath(),
      qualcomm_options.GetDispatchCustomOpPackageTarget(),
      qualcomm_options.GetDispatchCustomOpPackageInterfaceProvider());
