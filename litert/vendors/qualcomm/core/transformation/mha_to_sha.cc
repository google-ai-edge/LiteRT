...
TensorWrapper& BuildSingleSHA(
  ...
  new_ops.emplace_back(
      BuildSliceOp(softmax_output, slice_1_output, sha_slice_1_ranges));
  ...
  new_ops.emplace_back(
      BuildSliceOp(softmax_output, slice_2_output, sha_slice_2_ranges));
...
TensorWrapper& BuildSingleSHA(
  ...
  auto& slice_1_output = tensor_pool.CloneNativeTensorFrom(
      slice_1.GetOutputTensor(0), slice_1_output_dims);
  new_ops.emplace_back(
      BuildSliceOp(softmax_output, slice_1_output, slice_1_param_tensor));
  ...
  auto& slice_2_output = tensor_pool.CloneNativeTensorFrom(
      slice_2.GetOutputTensor(0), slice_2_output_dims);
  new_ops.emplace_back(
      BuildSliceOp(softmax_output, slice_2_output, slice_2_param_tensor));
