...
TEST(SerializeOpToJson, ElementWiseAdd) {
...
TEST(SerializeQuantParamToJson, RMSNorm_Axes) {
...
TEST(SerializeScalarParamToJson, RMSNorm_Epsilon) {
...
TEST(SerializeTensorAndParamToJson, RMSNorm_Axes) {
