...
#include "litert/vendors/qualcomm/core/utils/backend_utils.h"
 ...
 private:
  ...
  void SetPowerConfigs(std::array<QnnDspPerfInfrastructure_PowerConfig_t,
    ...
    power_configs[kDcvsVcornerTarget].config =
        QNN_DSP_PERF_INFRASTRUCTURE_POWER_CONFIGOPTION_DCVS_VOLTAGE_CORNER;
    power_configs[kDcvsVcornerTarget].busVoltageCornerTargetConfig =
        voltage_target;

    power_configs[kDcvsVcornerMax].config =
        QNN_DSP_PERF_INFRASTRUCTURE_POWER_CONFIGOPTION_DCVS_VOLTAGE_CORNER;
    power_configs[kDcvsVcornerMax].busVoltageCornerMaxConfig = voltage_max;
  ...
  void InitUpVotePowerConfigs(DspPerformanceMode perf_mode) {
    switch (perf_mode) {
      ...
      case ::qnn::DspPerformanceMode::kPowerSaver:
        SetPowerConfigs(
            up_vote_power_configs_, ::qnn::PowerConfig::kSleepMediumLatency,
            DCVS_VOLTAGE_VCORNER_SVS, DCVS_VOLTAGE_VCORNER_SVS,
            DCVS_VOLTAGE_VCORNER_SVS, ::qnn::PowerConfig::kDcvsDisable,
            QNN_DSP_PERF_INFRASTRUCTURE_POWERMODE_PERFORMANCE_MODE);
        break;
      case ::qnn::DspPerformanceMode::kLowPowerSaver:
        SetPowerConfigs(
            ...
            DCVS_VOLTAGE_VCORNER_SVS2, ::qnn::PowerConfig::kDcvsDisable,
            QNN_DSP_PERF_INFRASTRUCTURE_POWERMODE_PERFORMANCE_MODE);
        break;
      case ::qnn::DspPerformanceMode::kHighPowerSaver:
        SetPowerConfigs(
            ...
            DCVS_VOLTAGE_VCORNER_SVS_PLUS, ::qnn::PowerConfig::kDcvsDisable,
            QNN_DSP_PERF_INFRASTRUCTURE_POWERMODE_PERFORMANCE_MODE);
        break;
      case ::qnn::DspPerformanceMode::kLowBalanced:
        SetPowerConfigs(
            ...
            DCVS_VOLTAGE_VCORNER_NOM, ::qnn::PowerConfig::kDcvsDisable,
            QNN_DSP_PERF_INFRASTRUCTURE_POWERMODE_PERFORMANCE_MODE);
        break;
      case ::qnn::DspPerformanceMode::kBalanced:
        SetPowerConfigs(
            ...
            DCVS_VOLTAGE_VCORNER_NOM_PLUS, ::qnn::PowerConfig::kDcvsDisable,
            QNN_DSP_PERF_INFRASTRUCTURE_POWERMODE_PERFORMANCE_MODE);
        break;
      default:
    ...
    SetNullTermPtrArray(up_vote_power_configs_, up_vote_power_configs_ptr_);
  }
  ...
  void InitDownVotePowerConfigs() {
    SetPowerConfigs(down_vote_power_configs_,
                    ...
                    DCVS_VOLTAGE_VCORNER_SVS, ::qnn::PowerConfig::kDcvsEnable,
                    QNN_DSP_PERF_INFRASTRUCTURE_POWERMODE_POWER_SAVER_MODE);
    SetNullTermPtrArray(down_vote_power_configs_, down_vote_power_configs_ptr_);
  }
