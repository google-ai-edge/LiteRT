...
constexpr SocInfo kSocInfos[] = {
    ...
    {SocInfo("SXR2330P", SnapdragonModel::SXR2330P, DspArch::V79,
             8  // vtcm_size_in_mb
             )},
    {SocInfo("QCS9100", SnapdragonModel::QCS9100, DspArch::V73,
             8  // vtcm_size_in_mb
             )},
    {SocInfo("QCS9075", SnapdragonModel::QCS9100, DspArch::V73,
             8  // vtcm_size_in_mb
             )},
    {SocInfo("QCS8300", SnapdragonModel::QCS8300, DspArch::V75,
             8  // vtcm_size_in_mb
             )},
    {SocInfo("QCS8275", SnapdragonModel::QCS8300, DspArch::V75,
             8  // vtcm_size_in_mb
             )},
    ...
    {SocInfo("SW6100", SnapdragonModel::SW6100, DspArch::V81,
             4  // vtcm_size_in_mb
             )},
    {SocInfo("SM8845", SnapdragonModel::SM8845, DspArch::V81,
             8  // vtcm_size_in_mb
             )},
