...
public:
    ...
    size_t original_size;              // NOLINT(*-readability-class-member-naming)
    size_t bin_offset;                 // NOLINT(*-readability-class-member-naming)
    ov::element::Type original_dtype;  // NOLINT(*-readability-class-member-naming)
};
