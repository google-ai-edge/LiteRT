...
class DecoderOperation : public ov::frontend::tensorflow_lite::DecoderBaseOperation {
public:
    ...
    void get_input_node(size_t input_port_idx, std::string &producer_name,
        ...
        // TODO: Needs implementation ? Benchmark/demo app worked fine even without it.
        return;
    }
...
public:
    explicit DecoderTensor(ov::frontend::tensorflow_lite::TensorMetaInfo tensor_meta_info,
