...
constexpr absl::string_view kPrecompiledTfliteFile =
    "simple_model_npu_precompiled.tflite";
...
TEST(OpenVino, DispatchApi) {
  ...
  auto model_file_name = std::string("./") + kNpuModelFileName;
#else
  auto model_file_name = litert::testing::GetTestFilePath(kNpuModelFileName);
#endif
