...
#ifndef ODML_LITERT_LITERT_VENDORS_CC_CONVERT_GRAPH_H_
#define ODML_LITERT_LITERT_VENDORS_CC_CONVERT_GRAPH_H_
...
#endif  // ODML_LITERT_LITERT_VENDORS_CC_CONVERT_GRAPH_H_
