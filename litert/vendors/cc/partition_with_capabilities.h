...
#ifndef ODML_LITERT_LITERT_VENDORS_CC_PARTITION_WITH_CAPABILITIES_H_
#define ODML_LITERT_LITERT_VENDORS_CC_PARTITION_WITH_CAPABILITIES_H_
...
#endif  // ODML_LITERT_LITERT_VENDORS_CC_PARTITION_WITH_CAPABILITIES_H_
