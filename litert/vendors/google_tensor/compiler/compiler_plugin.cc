...
class LiteRtCompilerPluginT {
 public:
  ...
  void SetLiteRtApiVersion(LiteRtApiVersion v) { litert_version_ = v; }
  LiteRtApiVersion GetLiteRtApiVersion() const { return litert_version_; }
...
LiteRtStatus LiteRtCompilerPluginCompile(
  ...
  LiteRtApiVersion litert_version =
      compiler_plugin->GetLiteRtApiVersion();
  std::string api_version_str =
      absl::StrFormat("%d.%d.%d", litert_version.major,
                      litert_version.minor, litert_version.patch);
  ...
  compiler_config->set_litert_api_version(api_version_str);
...
LiteRtStatus LiteRtCompilerPluginCheckCompilerCompatibility(
    ...
    const char* soc_model_name) {
  compiler_plugin->SetLiteRtApiVersion(api_version);
  return kLiteRtStatusOk;
}
