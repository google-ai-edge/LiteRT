...
TEST(GoogleTensorNpuStaticLinkTest, RegistersStaticallyLinkedAccelerator) {
...
TEST(GoogleTensorNpuStaticLinkTest, CanCreateCompiledModel) {
...
TEST(GoogleTensorNpuStaticLinkTest, CanRunCompiledModel) {
  auto path = testing::GetTestFilePath(
      "simple_model_npu_google_tensor_precompiled.tflite");
