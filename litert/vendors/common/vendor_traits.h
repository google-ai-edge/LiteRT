...
// Base template for vendor traits - all specializations must provide these members
...
struct VendorTraits<GoogleTensorTag> {
  ...
  static Expected<LiteRtDispatchGraphHandle> CreateGraph();
  static LiteRtStatus DestroyGraph(LiteRtDispatchGraphHandle graph);
  static LiteRtStatus AddNode(LiteRtDispatchGraphHandle graph,
                             LiteRtDispatchNodeId node_id,
                             LiteRtDispatchNodeType node_type);
  static LiteRtStatus AddEdge(LiteRtDispatchGraphHandle graph,
