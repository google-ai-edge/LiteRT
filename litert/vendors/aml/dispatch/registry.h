...
#ifndef LITERT_LITERT_VENDORS_AML_DISPATCH_REGISTRY_H_
#define LITERT_LITERT_VENDORS_AML_DISPATCH_REGISTRY_H_
...
#endif // LITERT_LITERT_VENDORS_AML_DISPATCH_REGISTRY_H_
