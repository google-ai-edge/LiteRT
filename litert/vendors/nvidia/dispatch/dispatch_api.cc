 ...
 public:
  static Expected<std::unique_ptr<LiteRtDispatchInvocationContextT>> Create(
    ...
    if (aot_locator.has_value()) {
      litert::nvidia::LogMemoryProfile("dispatch", "aot_artifact_map_begin",
                                       function_name);
      ...
      litert::nvidia::LogMemoryProfile("dispatch",
                                       aot_artifact->validation_reused()
    ...
    if (aot_artifact) {
      ...
      aot_artifact.reset();
      litert::nvidia::LogMemoryProfile("dispatch", "aot_artifact_unmapped",
                                       function_name);
    }
