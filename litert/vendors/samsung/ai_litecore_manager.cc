...
#include "graph_wrapper_api.h"  // from @exynos_ai_litecore
#include "graphgen_c.h"  // from @exynos_ai_litecore
...
Expected<AiLiteCoreManager::UniquePtr> AiLiteCoreManager::Create(
...
LiteRtStatus AiLiteCoreManager::LoadGraphWrapperLibrary(
