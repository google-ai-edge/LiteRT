...
package com.google.ai.edge.litert.support.image.ops;
...
import com.google.ai.edge.litert.support.image.ColorSpaceType;
import com.google.ai.edge.litert.support.image.ImageOperator;
 ...
 *
 * <ul>
 *   <li>{@link com.google.ai.edge.litert.support.image.ColorSpaceType#RGB}
 * </ul>
 *
...
public class TransformToGrayscaleOp implements ImageOperator {
   ...
   * com.google.ai.edge.litert.support.image.ColorSpaceType#GRAYSCALE}, this op will be a no-op.
   *
   * @throws IllegalArgumentException if the {@code image} is not {@link
   *     com.google.ai.edge.litert.support.image.ColorSpaceType#RGB} or {@link
   *     com.google.ai.edge.litert.support.image.ColorSpaceType#GRAYSCALE}.
   */
  @Override
