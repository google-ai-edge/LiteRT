...
package com.google.ai.edge.litert.support.common.ops;
...
import com.google.ai.edge.litert.support.tensorbuffer.TensorBufferFloat;
...
public class NormalizeOp implements TensorOperator {
   ...
   */
  public NormalizeOp(float @NonNull [] mean, float @NonNull [] stddev) {
