...
package com.google.ai.edge.litert.support.label;
 ...
 * than 1.
 *
 * @see com.google.ai.edge.litert.support.common.FileUtil#loadLabels(Context, String) to load labels
 *     from a label file (plain text file whose each line is a label) in assets simply.
 */
