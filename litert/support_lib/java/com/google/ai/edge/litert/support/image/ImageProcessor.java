...
import com.google.ai.edge.litert.support.common.Operator;
import com.google.ai.edge.litert.support.common.SequentialProcessor;
import com.google.ai.edge.litert.support.common.TensorOperator;
import com.google.ai.edge.litert.support.common.internal.SupportPreconditions;
import com.google.ai.edge.litert.support.image.ops.Rot90Op;
import com.google.ai.edge.litert.support.image.ops.TensorOperatorWrapper;
...
public class ImageProcessor extends SequentialProcessor<TensorImage> {
  ...
  public static class Builder extends SequentialProcessor.Builder<TensorImage> {
     ...
     * the underlying {@link com.google.ai.edge.litert.support.tensorbuffer.TensorBuffer}.
     *
     * @param op the Operator instance to be executed then
     */
