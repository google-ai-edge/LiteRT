...
from litert.support_lib.metadata.python.metadata_writers import bert_nl_classifier
from litert.support_lib.metadata.python.metadata_writers import metadata_info
from litert.support_lib.metadata.python.tests.metadata_writers import test_utils

_TEST_DIR = "third_party/odml/litert/support_lib/metadata/python/tests/testdata/bert_nl_classifier/"
