...
class ScoreCalibrationMd:
  ...
  def __init__(
      self, score_transformation_type: int, default_score: float, file_path: str
  ):
...
class TensorMd:
  ...
  def __init__(
      ...
      associated_files: Optional[Sequence[AssociatedFileMd]] = None,
  ...
  def create_metadata(self) -> _metadata_fb.TensorMetadataT:
    ...
    stats.max = list(self.max_values) if self.max_values is not None else None
    stats.min = list(self.min_values) if self.min_values is not None else None
...
class InputImageTensorMd(TensorMd):
  ...
  def create_metadata(self) -> _metadata_fb.TensorMetadataT:
    ...
    assert isinstance(
        tensor_metadata.content.contentProperties, _metadata_fb.ImagePropertiesT
    )
...
class InputAudioTensorMd(TensorMd):
  ...
  def create_metadata(self) -> _metadata_fb.TensorMetadataT:
    ...
    assert tensor_metadata.content is not None
    assert isinstance(
        tensor_metadata.content.contentProperties, _metadata_fb.AudioPropertiesT
    )
