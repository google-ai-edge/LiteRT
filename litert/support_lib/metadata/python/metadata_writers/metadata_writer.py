...
class MetadataWriter:
  ...
  def create_from_metadata_info(
      ...
      input_md: Optional[Sequence[metadata_info.TensorMd]] = None,
      output_md: Optional[Sequence[metadata_info.TensorMd]] = None,
      associated_files: Optional[List[str]] = None,
  ):
...
def _order_tensor_metadata(
    tensor_md: Sequence[metadata_info.TensorMd],
    tensor_names_from_model: List[str],
) -> List[metadata_info.TensorMd]:
