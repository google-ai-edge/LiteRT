...
_EXPORT_LRT_ONLY_SCRIPT_LINUX = "//third_party/odml/litert/litert/build_common:export_litert_only_linux.lds"
_EXPORT_LRT_ONLY_SCRIPT_DARWIN = "//third_party/odml/litert/litert/build_common:export_litert_only_darwin.lds"
...
def export_lrt_only_script():
    return select({
        "//third_party/tensorflow:linux_x86_64": [_EXPORT_LRT_ONLY_SCRIPT_LINUX],
        "//third_party/tensorflow:android": [_EXPORT_LRT_ONLY_SCRIPT_LINUX],
        "//third_party/tensorflow:macos": [_EXPORT_LRT_ONLY_SCRIPT_DARWIN],
        "//third_party/tensorflow:ios": [_EXPORT_LRT_ONLY_SCRIPT_DARWIN],
        "//conditions:default": [],
    })

def export_lrt_only_linkopt():
    return select({
        "//third_party/tensorflow:linux_x86_64": [_EXPORT_LRT_ONLY_LINKOPT_LINUX],
        "//third_party/tensorflow:android": [_EXPORT_LRT_ONLY_LINKOPT_LINUX],
        "//third_party/tensorflow:macos": [_EXPORT_LRT_ONLY_LINKOPT_DARWIN],
        "//third_party/tensorflow:ios": [_EXPORT_LRT_ONLY_LINKOPT_DARWIN],
        "//conditions:default": [],
    }) + symbol_opts()

_EXPORT_LRT_RUNTIME_ONLY_SCRIPT_LINUX = "//third_party/odml/litert/litert/build_common:export_litert_runtime_only_linux.lds"
_EXPORT_LRT_RUNTIME_ONLY_SCRIPT_DARWIN = "//third_party/odml/litert/litert/build_common:export_litert_runtime_only_darwin.lds"
...
def export_lrt_runtime_only_script():
    return select({
        "//third_party/tensorflow:linux_x86_64": [_EXPORT_LRT_RUNTIME_ONLY_SCRIPT_LINUX],
        "//third_party/tensorflow:android": [_EXPORT_LRT_RUNTIME_ONLY_SCRIPT_LINUX],
        "//third_party/tensorflow:macos": [_EXPORT_LRT_RUNTIME_ONLY_SCRIPT_DARWIN],
        "//third_party/tensorflow:ios": [_EXPORT_LRT_RUNTIME_ONLY_SCRIPT_DARWIN],
        "//conditions:default": [],
    })

def export_lrt_runtime_only_linkopt():
    return select({
        "//third_party/tensorflow:linux_x86_64": _EXPORT_LRT_COMMON_LINKOPTS_LINUX + [_EXPORT_LRT_RUNTIME_ONLY_LINKOPT_LINUX],
        "//third_party/tensorflow:android": _EXPORT_LRT_COMMON_LINKOPTS_LINUX + [
            "-Wl,-z,max-page-size=16384",
            _EXPORT_LRT_RUNTIME_ONLY_LINKOPT_LINUX,
        ],
        "//third_party/tensorflow:macos": [_EXPORT_LRT_RUNTIME_ONLY_LINKOPT_DARWIN],
        "//third_party/tensorflow:ios": [_EXPORT_LRT_RUNTIME_ONLY_LINKOPT_DARWIN],
        "//conditions:default": [],
    }) + symbol_opts()
...
def _litert_base(
    ...
    if ungrte:
        append_rule_kwargs(
            cc_rule_kwargs,
            linkopts = select({
                "//third_party/tensorflow:linux_x86_64": [_SYS_ELF_INTERPRETER_LINKOPT_X86_64, _SYS_RPATHS_LINKOPT_X86_64],
                "//conditions:default": [],
            }),
        )
    rule(**cc_rule_kwargs)
...
def litert_test(
    ...
    """
    if use_sys_malloc:
        cc_test_kwargs["malloc"] = "//base:system_malloc"  # copybara:comment
        pass

    append_rule_kwargs(
        cc_test_kwargs,
        deps = ["//testing/base/public:gunit_main_no_google3"],
    )
...
def gtest_main_no_heapcheck_deps():
    ...
    # return ["//testing/base/public:gunit_main_no_google3"]
