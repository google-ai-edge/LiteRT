...
class DispatchDelegate : public tflite::SimpleOpaqueDelegateInterface {
 ...
 private:
  ...
  litert::internal::DispatchDeviceContextSharedPtr device_context_;
};
...
litert::Expected<void> DispatchDelegate::InitializeDispatchApi() {
  ...
  device_context_ = litert::internal::DispatchDeviceContextSharedPtr(
      device_context, LiteRtDispatchDeviceContextDestroy);
