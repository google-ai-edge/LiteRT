...
#include "litert/test/testdata/simple_mixed_cascade_model_test_vectors.h"
...
TEST(DispatchDelegate, CompiledModel) {
  ...
  EXPECT_THAT(input_buffer_types_arg0, ElementsAre(TensorBufferType::Ahwb));
  ...
  EXPECT_THAT(input_buffer_types_arg1, ElementsAre(TensorBufferType::Ahwb));
  ...
  EXPECT_THAT(input_buffer_types_arg2, ElementsAre(TensorBufferType::Ahwb));
  ...
  EXPECT_THAT(input_buffer_types_arg3,
              ElementsAre(TensorBufferType::HostMemory));
  ...
  EXPECT_THAT(input_buffer_types_arg4, ElementsAre(TensorBufferType::Ahwb));
  ...
  EXPECT_THAT(output_buffer_types, ElementsAre(TensorBufferType::Ahwb));
  ...
  ASSERT_EQ(input_buffers.size(), 5);
  ...
  ASSERT_TRUE(input_buffers[4].Write<float>(
      absl::MakeConstSpan(kTestInput4Tensor_1, kTestInput4Size)));
  ...
  ASSERT_TRUE(input_buffers[4].Write<float>(
      absl::MakeConstSpan(kTestInput4Tensor_2, kTestInput4Size)));
  ...
  ASSERT_TRUE(input_buffers[4].Write<float>(
      absl::MakeConstSpan(kTestInput4Tensor_3, kTestInput4Size)));
