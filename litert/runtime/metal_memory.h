...
class MetalMemory {
 public:
  ...
  explicit MetalMemory(MetalDevice* device, const LiteRtRankedTensorType& tensor_type,
                       LiteRtTensorBufferType buffer_type, Buffer buffer, void* data)
  ...
  MetalMemory(GpuEnvironment* gpu_env, const LiteRtRankedTensorType& tensor_type,
              LiteRtTensorBufferType buffer_type, Buffer buffer, size_t size,
