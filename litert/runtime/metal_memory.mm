...
#include "third_party/odml/litert/litert/runtime/metal_memory.h"

#import <Metal/Metal.h>
#import <sys/utsname.h>
#import "third_party/odml/litert/litert/runtime/metal_sync.h"
...
#include "third_party/odml/litert/litert/core/util/tensor_type_util.h"
#include "third_party/odml/litert/litert/runtime/litert_gpu_util.h"
#include "third_party/odml/litert/litert/runtime/tensor_buffer_lockstate.h"
#include "third_party/tensorflow/lite/delegates/gpu/metal/buffer.h"
#include "third_party/tensorflow/lite/delegates/gpu/metal/common.h"
#include "third_party/tensorflow/lite/delegates/gpu/metal/gpu_object.h"
...
Expected<void> MetalMemory::Unlock() {
  ...
  if (lock_state_ == LockState::kWrite || lock_state_ == LockState::kReadWrite) {
...
Expected<MetalMemory> MetalMemory::Alloc(GpuEnvironment* gpu_env,
  ...
  metal_buffer = tflite::gpu::metal::Buffer(buffer_memory, bytes_size);
