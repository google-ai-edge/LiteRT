...
class GpuOpenClAccelerator {
 public:
  ...
  static void Destroy(void* accelerator) {
    delete reinterpret_cast<GpuOpenClAccelerator*>(accelerator);
  }
...
// Discovery C object for the GPU OpenCL accelerator by LiteRT.
...
extern "C" LiteRtAcceleratorDef LiteRtAcceleratorImpl = {
    ...
    .get_name = GpuOpenClAccelerator::GetName,
    .get_version = GpuOpenClAccelerator::GetVersion,
    .get_hardware_support = GpuOpenClAccelerator::GetHardwareSupport,
    .is_tflite_delegate_responsible_for_jit_compilation =
        GpuOpenClAccelerator::IsTfLiteDelegateResponsibleForJitCompilation,
    .create_delegate = GpuOpenClAccelerator::CreateDelegate,
    .buffer_handlers =
        {
