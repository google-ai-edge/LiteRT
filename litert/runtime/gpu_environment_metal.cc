...
#include "litert/runtime/gpu_environment_metal.h"
...
void LiteRtDeleteMetalInfo(MetalInfoPtr metal_info) {
  if (metal_info) {
    // Cast the C-style pointer back to the C++ class pointer and delete it.
    // This correctly calls the destructor for MetalInfoImpl.
    delete reinterpret_cast<MetalInfoImpl*>(metal_info);
  }
}
...
// #else
// #warning "LITERT_HAS_METAL_SUPPORT is FALSE" // Add this
