...
ABSL_FLAG(litert::qualcomm::QualcommOptions::HtpPerfCtrlMode,
          ...
          "HTP performance control mode. 'manual' (default): upvote once at "
          "context creation, downvote at destruction. 'auto': per-inference "
          "upvote with a 300ms debounced downvote.");
...
ABSL_FLAG(litert::qualcomm::QualcommOptions::DspPerfCtrlMode,
          ...
          "DSP performance control mode. 'manual' (default): upvote once at "
          "context creation, downvote at destruction. 'auto': per-inference "
          "upvote with a 300ms debounced downvote.");
