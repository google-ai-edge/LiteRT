...
void ExampleIntelOpenVinoFlagsUsage(int argc, char** argv) {
  ...
  if (!options_result) {
    LITERT_LOG(LITERT_ERROR, "Failed to create Intel OpenVINO options from flags");
    return;
  }
  ...
  // Now you can use these options to configure your Intel OpenVINO compiler plugin
