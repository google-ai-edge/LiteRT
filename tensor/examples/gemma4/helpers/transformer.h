...
template <class... Mixins>
absl::StatusOr<TransformerLayerOutput<Mixins...>> TransformerLayer(
  ...
  LRT_TENSOR_ASSIGN_OR_RETURN(
      ...
      Attention(normed_input, attention_mask, cos, sin, key_cache, value_cache,
                ...
                config.GetLayerType(layer_idx), eps_tensor));
  ...
  return TransformerLayerOutput<Mixins...>{
      output, attn_out.key_cache, attn_out.value_cache, attn_out.key_for_attn,
