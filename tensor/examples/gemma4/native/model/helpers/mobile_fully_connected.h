...
#ifndef LITERT_TENSOR_EXAMPLES_GEMMA4_NATIVE_MODEL_HELPERS_MOBILE_FULLY_CONNECTED_H_
#define LITERT_TENSOR_EXAMPLES_GEMMA4_NATIVE_MODEL_HELPERS_MOBILE_FULLY_CONNECTED_H_
...
Tensor<Mixins...> MobileFullyConnected(
  ...
  Tensor<Mixins...> quantized_output = weight.GetType() == Type::kI2
      ? StaticInt2FullyConnected(quantized_input, weight)
      : FullyConnected(quantized_input, weight);
...
#endif  // LITERT_TENSOR_EXAMPLES_GEMMA4_NATIVE_MODEL_HELPERS_MOBILE_FULLY_CONNECTED_H_
