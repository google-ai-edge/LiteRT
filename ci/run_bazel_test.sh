...
EXCLUDED_TARGETS=(
        ...
        "-//tflite/experimental/acceleration/mini_benchmark:mini_benchmark_test"
        "-//tflite/experimental/acceleration/mini_benchmark:validator_runner_impl_opaque_delegate_test"
        "-//tflite/experimental/acceleration/mini_benchmark:validator_runner_impl_test"
        "-//tflite/experimental/acceleration/mini_benchmark:validator_runner_test"
        ...
        "-//tflite/toco/tflite:types_test"
        "-//tflite/toco/tflite:operator_test"
        "-//tflite/toco/tflite:export_test"
        "-//tflite/toco/tensorflow_graph_matching:resolve_svdf_test"
        "-//tflite/toco/logging:conversion_log_util_test"
        "-//tflite/toco/graph_transformations/tests:unpack_quantize_test"
        "-//tflite/toco/graph_transformations/tests:resolve_constant_unary_test"
        "-//tflite/toco/graph_transformations/tests:resolve_constant_concatenation_test"
        "-//tflite/toco/graph_transformations/tests:remove_successive_transpose_test"
        "-//tflite/toco/graph_transformations/tests:lstm_utils_test"
        "-//tflite/toco/graph_transformations/tests:identify_l2_pool_test"
        "-//tflite/toco/graph_transformations/tests:identify_l2_normalization_test"
        "-//tflite/toco/graph_transformations/tests:fuse_binary_into_preceding_affine_test"
        "-//tflite/toco/graph_transformations/tests:fuse_binary_into_following_affine_test"
        "-//tflite/toco:tooling_util_test"
        "-//tflite/toco:toco_convert_test"
        "-//tflite/toco:toco_cmdline_flags_test"
        "-//tflite/toco:model_cmdline_flags_test"
        "-//tflite/toco:import_tensorflow_test"
