...
EXYNOS_AI_LITECORE_URL = 'https://soc-developer.semiconductor.samsung.com/api/v1/resource/download-file/1.1.0/ai-litecore-ubuntu2404-v1.1.0.tar.gz'  # pylint: disable=line-too-long
...
def _download_and_extract(
    ...
    if not (IS_LINUX and IS_X86_ARCHITECTURE):
        print(
            'IGNORED: Currently LiteRT NPU AOT for samsung is only supported on'
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        archive_name_local = os.path.join(tmpdir, "ai-litecore")
    ...
    def run(self):
        ...
        if SKIP_SDK_DOWNLOAD:
            ...
            _download_and_extract(
                EXYNOS_AI_LITECORE_URL, EXYNOS_AI_LITECORE_CONTENT_DIR, EXYNOS_AI_LITECORE_TARGET_DIR
            )
...
setuptools.setup(
    ...
    packages=['ai_edge_litert_sdk_samsung'],
    package_dir={'ai_edge_litert_sdk_samsung': 'ai_edge_litert_sdk_samsung'},
