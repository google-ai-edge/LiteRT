...
def qairt():
    configurable_repo(
        ...
        strip_prefix = "qairt/2.49.0.260730",
        url = "https://softwarecenter.qualcomm.com/api/download/software/sdks/Qualcomm_AI_Runtime_Community/All/2.49.0.260730/v2.49.0.260730.zip",
        file_extension = "zip",
    )
