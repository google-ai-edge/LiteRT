...
def arm_deps():
    http_archive(
        ...
        build_file = "@//third_party/arm/vulkan_headers:BUILD.arm_dep_vulkan_headers",
    ...
    http_archive(
        ...
        build_file = "@//third_party/arm/ai_ml_sdk_vgf_library:BUILD.ai_ml_sdk_vgf_library",
    ...
    http_archive(
        ...
        build_file = "@//third_party/arm/tosa_for_spirv_codegen:BUILD.tosa_for_spirv_codegen",
