...
#ifndef THIRD_PARTY_ODML_LITERT_ML_DRIFT_TFLITE_SUPPORT_SUPPORT_ABSOLUTE_POSITIONAL_EMBEDDING_H_
#define THIRD_PARTY_ODML_LITERT_ML_DRIFT_TFLITE_SUPPORT_SUPPORT_ABSOLUTE_POSITIONAL_EMBEDDING_H_
...
// Validates an Absolute Positional Embedding operation node to determine if
// it is supported.
//
...
#endif  // THIRD_PARTY_ODML_LITERT_ML_DRIFT_TFLITE_SUPPORT_SUPPORT_ABSOLUTE_POSITIONAL_EMBEDDING_H_
