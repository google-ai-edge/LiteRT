...
class ConvertResamplerTest : public ::testing::Test {};

TEST_F(ConvertResamplerTest, Basic) {
  ...
  model.SetCustomName("Resampler");

  model.AddInput(kTfLiteFloat32, {1, 2, 2, 1});
  model.AddInput(kTfLiteFloat32, {1, 2, 2, 2});
  model.AddOutput(kTfLiteFloat32, {1, 2, 2, 1});
