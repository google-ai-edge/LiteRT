...
#ifndef THIRD_PARTY_ODML_LITERT_ML_DRIFT_DELEGATE_BUFFER_HANDLER_WEBGPU_H_
#define THIRD_PARTY_ODML_LITERT_ML_DRIFT_DELEGATE_BUFFER_HANDLER_WEBGPU_H_
...
// Custom TensorBuffer handlers for WebGPU memory. These handlers are registered
// via TensorBufferRegistry API and used to support WebGPU memory.
...
#endif  // THIRD_PARTY_ODML_LITERT_ML_DRIFT_DELEGATE_BUFFER_HANDLER_WEBGPU_H_
