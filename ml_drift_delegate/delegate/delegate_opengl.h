...
#ifndef THIRD_PARTY_ODML_LITERT_ML_DRIFT_DELEGATE_DELEGATE_OPENGL_H_
#define THIRD_PARTY_ODML_LITERT_ML_DRIFT_DELEGATE_DELEGATE_OPENGL_H_
...
// Deletes an existing ML Drift OpenGL delegate object incl. all its resources.
...
// Additional ML Drift OpenGL Delegate C++ APIs.
//
// Typical usage:
//
//   // Initialize.
//   MlDriftDelegateOptionsPtr options =
//   MlDriftOpenGlDelegateDefaultOptionsPtr(); tflite::TfLiteDelegatePtr
//   delegate =
//       CreateMlDriftOpenGlDelegate(std::move(options));
//
...
#endif  // THIRD_PARTY_ODML_LITERT_ML_DRIFT_DELEGATE_DELEGATE_OPENGL_H_
