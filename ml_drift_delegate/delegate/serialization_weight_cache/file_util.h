...
#ifndef THIRD_PARTY_ODML_LITERT_ML_DRIFT_DELEGATE_SERIALIZATION_WEIGHT_CACHE_FILE_UTIL_H_
#define THIRD_PARTY_ODML_LITERT_ML_DRIFT_DELEGATE_SERIALIZATION_WEIGHT_CACHE_FILE_UTIL_H_
...
class FileDescriptor {
 public:
  ...
  //
  // WARNING: the file descriptor must be valid and the file must be opened.
  Offset SetPos(size_t position) const;
  ...
  //
  // WARNING: the file descriptor must be valid and the file must be opened.
  Offset SetPosFromEnd(size_t offset) const;
  ...
  //
  // WARNING: the file descriptor must be valid and the file must be opened.
  Offset MovePos(size_t offset) const;
  ...
  //
  // This is a convenience function wrapping the standard `ftruncate` function.
  // If you need finer grain control use that directly.
  [[nodiscard /*Truncating a file may fail.*/]]
  bool Truncate(size_t size = 0) const;
...
#endif  // THIRD_PARTY_ODML_LITERT_ML_DRIFT_SERIALIZATION_WEIGHT_CACHE_FILE_UTIL_H_
