...
#ifndef THIRD_PARTY_ODML_LITERT_TENSOR_EXAMPLES_SEGMENTATION_IMAGE_UTILS_H_
#define THIRD_PARTY_ODML_LITERT_TENSOR_EXAMPLES_SEGMENTATION_IMAGE_UTILS_H_
...
#endif  // THIRD_PARTY_ODML_LITERT_TENSOR_EXAMPLES_SEGMENTATION_IMAGE_UTILS_H_
