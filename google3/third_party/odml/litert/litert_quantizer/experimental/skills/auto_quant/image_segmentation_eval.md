...
When utilizing the LiteRT Quantizer to compress models executing image
...
## 3. Implementing Task Metrics in LiteRT Quantizer

In LiteRT Quantizer, you can define custom task metrics that process the output masks.
