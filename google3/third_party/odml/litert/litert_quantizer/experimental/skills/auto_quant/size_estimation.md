...
PyTorch `nn.Module` object trees, the LiteRT Quantizer operates directly
...
This document describes how to measure sizes in standard LiteRT Quantizer workflows and
