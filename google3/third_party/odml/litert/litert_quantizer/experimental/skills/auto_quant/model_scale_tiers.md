---
name: litertq-model-scale-tiers
description: >-
...
1.  **Baseline**: ALL weight tensors at INT4 using **blockwise granularity**
    ...
    *   **Per-signature recipes**: LiteRT-LM bundles split the model into
        ...
        in LiteRT Quantizer's `recipe.py` as the reference structure) and pass
...
6.  **Optional INT2 demotion axis (aggressive size targets only)**: LiteRT Quantizer ships
