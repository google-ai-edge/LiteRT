...
AI Edge Quantizer is a **post training quantization (PTQ) tool** for
...
The AI Edge Quantizer is one of many different tools for quantization across
...
[TfLite quantizer][TfLite]. Feature parity of AI Edge Quantizer to TFLite
Quantizer is WIP.

See http://go/ai-edge-quantizer for more details.
